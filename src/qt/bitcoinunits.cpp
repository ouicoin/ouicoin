...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("OUI");
    case mBTC: return QString("mOUI");
    case uBTC: return QString::fromUtf8("μOUI");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("OuiCoins");
    case mBTC: return QString("Milli-OuiCoins (1 / 1,000)");
    case uBTC: return QString("Micro-OuiCoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
